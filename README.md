...
<!-- PROJECT DESCRIPTION -->
# 📖 [Expanding_Cards] <a name="about-project"></a>

**Expanding_Cards** contains an expanding galleris of photoes built with JavaScript.
...
```sh
  ...
  git git@github.com:78fatemanazari/Expanding_Cards.git
```
